...
{
    wp_enqueue_style('somo-theme-style', get_stylesheet_uri(), array(), '1.0.2');
    ...
    // Mobile Navigation
    wp_enqueue_script('somo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0.0', true);
}
